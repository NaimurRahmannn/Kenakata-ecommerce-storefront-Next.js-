...
function ProductCard({ product }: { product: Product }) {
  return (
    <article className="group overflow-hidden rounded-2xl border border-[#eadfce] bg-[#fffdf8] shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#c3a06a] hover:shadow-xl hover:shadow-zinc-900/10 dark:border-zinc-800 dark:bg-[#141310] dark:hover:border-[#d6b36a]">
      <div className="relative h-72 bg-[#f3ede3] dark:bg-[#1a1916]">
      ...
      <div className="flex min-h-64 flex-col p-5">
        ...
        <h3 className="mt-3 line-clamp-2 min-h-12 text-lg font-semibold leading-6 text-zinc-950 dark:text-zinc-100">
          <Link
        ...
        <div className="mt-auto flex items-center justify-between gap-4 pt-6">
          ...
          <ButtonLink
            ...
            variant="outline"
            size="sm"
            className="border-[#c3a06a] text-zinc-950 hover:bg-[#f6efe4] dark:border-[#d6b36a] dark:text-zinc-100 dark:hover:bg-[#201b14]"
          >
            View Details
          </ButtonLink>
        </div>
...
export async function FeaturedProducts() {
  ...
  return (
    <section className="bg-[#faf7f1] pb-10 pt-8 sm:pb-20 sm:pt-10 lg:pb-10 lg:pt-10 dark:bg-[#0f0e0c]">
      <Container>
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <SectionTitle
              ...
              className="mt-3 [&_h2]:text-zinc-950 dark:[&_h2]:text-zinc-100"
            />
          </div>
        ...
        {products.length > 0 ? (
          ...
          <EmptyState
            ...
            actionHref="/products"
            className="mt-10 border-[#eadfce] bg-[#fffdf8] text-zinc-950 dark:border-zinc-800 dark:bg-[#141310] dark:text-zinc-100"
          />
        )}
      </Container>
    </section>
