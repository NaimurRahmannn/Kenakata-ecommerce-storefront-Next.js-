    ...
    <main className="relative min-h-screen overflow-hidden bg-[#f7f1e9] dark:bg-[#0f0e0c]">
      ...
      <section className="relative z-10 px-4 pb-10 pt-6 md:pb-12 md:pt-8">
        <div className="mx-auto max-w-6xl">
          ...
          {/* Register Card */}
          <div className="mx-auto mt-4 w-full max-w-md rounded-2xl bg-white/95 px-5 py-5 shadow-[0_18px_50px_rgba(0,0,0,0.10)] backdrop-blur-md md:px-7 md:py-6 dark:bg-[#151310]/90">
            <div className="text-center">
            ...
            {/* Login Link */}
            <p className="mt-5 text-center text-sm text-neutral-700 dark:text-zinc-400">
